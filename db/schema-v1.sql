...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260903135141_InitialEvidenceModel'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20260903135141_InitialEvidenceModel', N'10.0.11');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260903135149_AppendOnlyTriggers'
)
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260903135149_AppendOnlyTriggers', N'10.0.11');
END;
